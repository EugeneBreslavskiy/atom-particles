...
export default {
    ...
    methods: {
        ...
        createObject() {
            ...
            // let planeInstance = new IntersectedPlane(0);
            // let plane = planeInstance.init();

            // let orbitInstance = new ParticlesOrbit(20, 10, this.uniforms);
            // let orbit = orbitInstance.init();

            //console.log(orbit);

            // let groupInstance = new AtomGroup(orbit, plane);
            // let group = groupInstance.init();

            // this.orbits.push(group.children[0]);
            // this.intersectedPlanes.push(group.children[1]);
            //
            // this.orbits.push(orbit.children[0]);
            // this.intersectedPlanes.push(orbit.children[2]);

            // console.log(this.intersectedPlanes);
        ...
        render() {
            ...
            // this.uniforms.time.value = Math.abs(Math.sin(performance.now() / 1000));
